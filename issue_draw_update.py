...
def UpdateIssueTable(lotId, issueNo, resultOnly):
    ...
    try:
        ...
        sql = "select Fdraw_result,Fint1,Fdraw_info from t_lottery_draw_result where Flottery_id='"+ lotId +"' and Fissue_no='"+ issueNo +"' and Fstatus in (0,2) and Fstate = 1 ORDER BY Fpriority DESC limit 1"
        #print sql
